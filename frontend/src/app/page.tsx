        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            <div className="w-8 h-8 rounded-lg bg-[#0F2044] flex items-center justify-center">
              <span className="text-white font-black text-xs tracking-tight">SR</span>
            </div>
      ...
      <section id="how" className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">How Sanraksh works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { n: "02", icon: "\ud83d\udd0d", title: "We monitor 24/7", desc: "Sanraksh tracks weather data, platform uptime, and government alerts across your registered zones all the time." },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed mb-6">Sanraksh exists to change that. We built the country's first parametric income protection product for gig workers — automatic, data-driven payouts that arrive before the worker even realizes they need help.</p>
            ...
            <div className="bg-[#0F2044] rounded-3xl p-8 text-white">
              <h3 className="text-xl font-bold mb-6 text-amber-400">How Sanraksh is different</h3>
              <div className="space-y-5">
                {[
                  { icon: "⚡", title: "No claims, ever", desc: "Traditional insurance makes you prove your loss. Sanraksh pays automatically when our data confirms the event happened in your zone." },
      ...
      <section id="help" className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-12">
            {[
              { icon: "📧", title: "Email Support", value: "support@sanraksh.in", sub: "We reply within 24 hours", href: "mailto:support@sanraksh.in" },
      ...
      <footer className="py-8 bg-[#060E1E] border-t border-[#1E3A5F]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-500 text-sm font-medium">Sanraksh</span>
          </div>
