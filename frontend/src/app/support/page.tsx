...
const FAQS = [
  ...
  { q: "Is this real insurance?", a: "GigArmor is a parametric income protection product, not a traditional insurance policy. It does not require IRDAI registration as it is an indemnity-based income support product. Coverage details are outlined in our Terms & Conditions." },
  ...
  { q: "What if I work on multiple platforms?", a: "You can register all platforms during sign-up. GigArmor calculates zone risk across all your platforms and pays out if any qualifying event hits your zone." },
  { q: "How is fraud detected?", a: "GigArmor uses AI models that analyze GPS jump patterns, device reuse across accounts, route feasibility, and peer-event correlation. Legitimate claims are never affected — the system only flags coordinated fraud rings." },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          {[
            { icon: "📧", title: "Email support", desc: "support@gigarmor.in", sub: "Response within 24 hours" },
      ...
      <footer className="border-t border-slate-200 mt-12 py-6 px-4 sm:px-6 text-center text-slate-400 text-sm">
        ...
        <Link href="/" className="hover:text-slate-700 transition-colors">GigArmor Home</Link>
        <span className="mx-3">·</span>
