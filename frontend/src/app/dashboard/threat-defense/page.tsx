  ...
  return (
    <div className="flex min-h-screen bg-[#030712] text-slate-100">
      ...
      <main className="ml-60 flex-1 p-8 space-y-6">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="rounded-2xl border border-red-500/30 bg-red-500/10 p-5">
          <p className="text-xs font-bold uppercase tracking-widest text-red-300">Adversarial Event Mode</p>
          <h1 className="mt-1 text-3xl font-black">🚨 Threat Defense Console</h1>
          <p className="mt-2 text-sm text-slate-300">Anti-spoofing response against GPS manipulation rings while preserving fast payout for genuine workers.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-4 xl:grid-cols-5">
          {[
            ...
            <motion.div key={String(label)} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 + i * 0.06 }} whileHover={{ y: -2 }} className={`rounded-xl border p-4 ${cls}`}>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 lg:col-span-1">
          ...
          <motion.div initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35 }} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 lg:col-span-2 overflow-x-auto">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5">
